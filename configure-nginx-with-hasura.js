...
if (!deepcaseDomain || !deeplinksDomain || !certbotEmail) {
  ...
  console.log('Usage: node configure-nginx.js --deepcase-domain chatgpt.deep.foundation --deeplinks-domain deeplinks.chatgpt.deep.foundation --hasura-domain hasura.deep.foundation --certbot-email your@email.com');
  process.exit(1);
}
